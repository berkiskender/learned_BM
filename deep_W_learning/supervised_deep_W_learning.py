...
np.save(os.path.join(path,'deep_Wmatrix_supervised_w_matched_%d_unmatched_%d_threshold_%.2f_gamma0_%.2f_refpatches_%d_subset_%d_BARBARA_512x512.npy' %(num_matches,num_unmatches,threshold,gamma_0,num_steps, subset_steps)),W)
...
torch.save(
    {'epoch': epoch, 'model_state_dict': W.state_dict(), 'optimizer_state_dict': opti.state_dict(),
     'loss': loss},
    os.path.join(path,'deep_Wmatrix_supervised_w_matched_%d_unmatched_%d_threshold_%.2f_gamma0_%.2f_refpatches_%d_subset_%d_BARBARA_512x512.tar' %(num_matches,num_unmatches,threshold,gamma_0,num_steps, subset_steps)))
